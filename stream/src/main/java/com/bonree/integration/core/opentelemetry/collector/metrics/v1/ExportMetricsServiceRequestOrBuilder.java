...
public interface ExportMetricsServiceRequestOrBuilder extends
   ...
   */
  java.util.List<com.bonree.integration.core.opentelemetry.metrics.v1.ResourceMetrics> 
   ...
   * <code>repeated .opentelemetry.proto.metrics.v1.ResourceMetrics resource_metrics = 1;</code>
   */
  com.bonree.integration.core.opentelemetry.metrics.v1.ResourceMetrics getResourceMetrics(int index);
  /**
   * <pre>
   * An array of ResourceMetrics.
   * For data coming from a single resource this array will typically contain one
   ...
   * <code>repeated .opentelemetry.proto.metrics.v1.ResourceMetrics resource_metrics = 1;</code>
   */
  java.util.List<? extends com.bonree.integration.core.opentelemetry.metrics.v1.ResourceMetricsOrBuilder> 
   ...
   * <code>repeated .opentelemetry.proto.metrics.v1.ResourceMetrics resource_metrics = 1;</code>
   */
  com.bonree.integration.core.opentelemetry.metrics.v1.ResourceMetricsOrBuilder getResourceMetricsOrBuilder(
      int index);
}
