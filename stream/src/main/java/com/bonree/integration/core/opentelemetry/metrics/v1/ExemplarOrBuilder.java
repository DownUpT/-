...
public interface ExemplarOrBuilder extends
   ...
   * <code>repeated .opentelemetry.proto.common.v1.KeyValue filtered_attributes = 7;</code>
   */
  com.bonree.integration.core.opentelemetry.common.v1.KeyValue getFilteredAttributes(int index);
  /**
   * <pre>
   * The set of key/value pairs that were filtered out by the aggregator, but
   * recorded alongside the original measurement. Only key/value pairs that were
   ...
   * <code>repeated .opentelemetry.proto.common.v1.KeyValue filtered_attributes = 7;</code>
   */
  com.bonree.integration.core.opentelemetry.common.v1.KeyValueOrBuilder getFilteredAttributesOrBuilder(
      int index);
