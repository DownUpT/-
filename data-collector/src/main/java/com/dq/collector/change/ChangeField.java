...
/**
 * Protobuf type {@code ChangeField}
 */
public final class ChangeField extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:ChangeField)
    ChangeFieldOrBuilder {
private static final long serialVersionUID = 0L;
  // Use ChangeField.newBuilder() to construct.
  private ChangeField(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  private ChangeField() {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return Test.internal_static_ChangeField_descriptor;
  }

  @Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return Test.internal_static_ChangeField_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            ChangeField.class, Builder.class);
  }
   ...
   */
  @Override
  public KeyValue getKeyValues(int index) {
   ...
   */
  @Override
  public KeyValueOrBuilder getKeyValuesOrBuilder(
      int index) {
    return keyValues_.get(index);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    ChangeField other = (ChangeField) obj;
  ...
  public static ChangeField parseFrom(
  ...
  public static ChangeField parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static ChangeField parseFrom(
  ...
  public static ChangeField parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static ChangeField parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static ChangeField parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(ChangeField prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:ChangeField)
      ChangeFieldOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Test.internal_static_ChangeField_descriptor;
    ...
    // Construct using com.dq.collector.change.ChangeField.newBuilder()
    private Builder() {
    ...
    @Override
    public ChangeField getDefaultInstanceForType() {
      return ChangeField.getDefaultInstance();
    }

    @Override
    public ChangeField build() {
      ChangeField result = buildPartial();
    ...
    @Override
    public ChangeField buildPartial() {
      ChangeField result = new ChangeField(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof ChangeField) {
        return mergeFrom((ChangeField)other);
      } else {
    ...
    public Builder mergeFrom(ChangeField other) {
      if (other == ChangeField.getDefaultInstance()) return this;
      if (keyValuesBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      ChangeField parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (ChangeField) e.getUnfinishedMessage();
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        KeyValue, KeyValue.Builder, KeyValueOrBuilder> keyValuesBuilder_;
     ...
     * <code>repeated .KeyValue keyValues = 1;</code>
     */
    public Builder addKeyValues(KeyValue value) {
      if (keyValuesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .KeyValue keyValues = 1;</code>
     */
    public KeyValue.Builder getKeyValuesBuilder(
        int index) {
    ...
    // @@protoc_insertion_point(builder_scope:ChangeField)
  }

  // @@protoc_insertion_point(class_scope:ChangeField)
  private static final ChangeField DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ChangeField();
  }

  public static ChangeField getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<ChangeField>
      PARSER = new com.google.protobuf.AbstractParser<ChangeField>() {
    @Override
    public ChangeField parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new ChangeField(input, extensionRegistry);
    }
  };

  public static com.google.protobuf.Parser<ChangeField> parser() {
    return PARSER;
  }

  @Override
  public com.google.protobuf.Parser<ChangeField> getParserForType() {
    return PARSER;
  }
